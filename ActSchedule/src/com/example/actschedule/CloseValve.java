...
public class CloseValve extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.closevalve); 
    ...
    protected Dialog onCreateDialog(int id) {
      switch(id) {
        ...
        pDialog.setTitle("Turning off water.....");
        ...
        public void handleMessage(Message msg) {
            ...
            if (total <= 0){
                dismissDialog(typeBar);
             	...
             	myAnimDraw.addFrame(getResources().getDrawable(R.drawable.watermeterr160_export1), 2000);
             	myAnimDraw.run();
             	myAnimDraw.setDuration(216000);
             	
             	myAnimDraw.addFrame(getResources().getDrawable(R.drawable.watermeterr150_export1), 2000);
             	myAnimDraw.run();
             	myAnimDraw.setDuration(216000);

             	myAnimDraw.addFrame(getResources().getDrawable(R.drawable.watermeterr140_export1), 2000);
                myAnimDraw.run();
             	myAnimDraw.setDuration(216000);
      
             	/*myAnimDraw.addFrame(getResources().getDrawable(R.drawable.watermeterr130_export1), 2000);
             	myAnimDraw.run();             	
             	myAnimDraw.setDuration(216000);
             	myAnimDraw.setOneShot(false);*/
             	
             	
             	myAnimDraw.addFrame(getResources().getDrawable(R.drawable.watermeterr120_export1), 2000);
             	myAnimDraw.run();             	
             	myAnimDraw.setDuration(216000);
             	myAnimDraw.setOneShot(false);
             	
             	myAnimDraw.addFrame(getResources().getDrawable(R.drawable.watermeterr110_export1), 2000);
             	myAnimDraw.run();             	
             	myAnimDraw.setDuration(216000);
             	myAnimDraw.setOneShot(false);
             	
             	/*myAnimDraw.addFrame(getResources().getDrawable(R.drawable.watermeterr100_export1), 2000);
             	myAnimDraw.run();             	
             	myAnimDraw.setDuration(216000);
             	myAnimDraw.setOneShot(false);
             	*/
             	...
             	/*myAnimDraw.addFrame(getResources().getDrawable(R.drawable.watermeterr70_export1), 2000);
             	myAnimDraw.run();             	
             	myAnimDraw.setDuration(216000);
             	myAnimDraw.setOneShot(false);*/
             	...
             	myAnimDraw.addFrame(getResources().getDrawable(R.drawable.watermeterr50_export1), 2000);
             	myAnimDraw.run();             	
             	myAnimDraw.setDuration(216000);
             	myAnimDraw.setOneShot(false);
             	
             	myAnimDraw.addFrame(getResources().getDrawable(R.drawable.watermeterr40_export1), 2000);
             	myAnimDraw.run();             	
             	myAnimDraw.setDuration(216000);
             	myAnimDraw.setOneShot(false);
             	...
             	myAnimDraw.addFrame(getResources().getDrawable(R.drawable.watermeterr20_export1), 2000);
             	myAnimDraw.run();             	
             	myAnimDraw.setDuration(216000);
             	myAnimDraw.setOneShot(false);
             	
             	myAnimDraw.addFrame(getResources().getDrawable(R.drawable.watermeterr10_export1), 2000);
             	myAnimDraw.run();             	
             	myAnimDraw.setDuration(216000);
             	myAnimDraw.setOneShot(false);
             	
             	myAnimDraw.addFrame(getResources().getDrawable(R.drawable.mywatermeter2), 2000);
             	myAnimDraw.run();             	
             	myAnimDraw.setDuration(216000);
             	myAnimDraw.setOneShot(false);
	                          	...
	                          	connected = false;
	                                ...
	                                runOnUiThread(new Runnable() {
	                     	         	  public void run()
	                     	         	  {
	                     	         	    ...
	                     	         	    Toast.makeText(CloseValve.this, "Valve Closed", Toast.LENGTH_LONG).show();
	                     	         	   
	                     	         	    Intent intent = new Intent(CloseValve.this,MainActivity.class);
    ...
    protected void onDestroy() {
       ...
       destroy(drawable);
       drawable = getResources().getDrawable(R.drawable.watermeterr10_export1);
       destroy(drawable);
       drawable = getResources().getDrawable(R.drawable.watermeterr20_export1);
       destroy(drawable);
       drawable = getResources().getDrawable(R.drawable.watermeterr40_export1);
       destroy(drawable);
       drawable = getResources().getDrawable(R.drawable.watermeterr50_export1);
       destroy(drawable);
       drawable = getResources().getDrawable(R.drawable.watermeterr60_export1);
       destroy(drawable);
       drawable = getResources().getDrawable(R.drawable.watermeterr80_export1);
       destroy(drawable);
       drawable = getResources().getDrawable(R.drawable.watermeterr90_export1);
       destroy(drawable);
       drawable = getResources().getDrawable(R.drawable.watermeterr110_export1);
       destroy(drawable);
       drawable = getResources().getDrawable(R.drawable.watermeterr120_export1);
       destroy(drawable);
       drawable = getResources().getDrawable(R.drawable.watermeterr140_export1);
       destroy(drawable);
       drawable = getResources().getDrawable(R.drawable.watermeterr150_export1);
       destroy(drawable);
       drawable = getResources().getDrawable(R.drawable.watermeterr160_export1);
       destroy(drawable);
